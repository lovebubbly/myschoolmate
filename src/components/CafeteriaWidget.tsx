...
export function CafeteriaWidget() {
    ...
    return (
        <Card className="relative overflow-hidden border-border/40 bg-card/60 backdrop-blur-md p-6 rounded-[32px] shadow-sm hover:shadow-md transition-shadow duration-300">
            {/* Header */}
